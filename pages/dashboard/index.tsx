...
import ClassesInfo from '../../src/components/DashboadComponents/ClassesInfo';
...
const Dashboard = () => {
  ...
  return (
    <section className="mx-auto p-5 md:p-10 max-w-screen-xl">
      <div className="container flex flex-col lg:grid gap-5">
        ...
        <div className="grid gap-5 grid-col-1 lg:grid-cols-3">
          {
            selectedTraining &&  <ClassesInfo training={selectedTraining} /> 
          }
        </div>
      </div>
    </section>
